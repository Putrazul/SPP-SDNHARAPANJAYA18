...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Nov 2024 pada 16.02
...
(3, 'risqoh', '123', 'Risqoh', 'petugas'),
(4, 'siswa1', 'siswa', 'Sulthan Putra', 'siswa'),
(14, 'siswa2', 'siswa', 'Muhammad Hisyam Putra', 'siswa');
...
CREATE TABLE `siswa` (
  ...
  `tlp_darurat` int(15) NOT NULL,
  `agama` varchar(7) NOT NULL,
  `hobi_minat` varchar(15) NOT NULL,
  `kegiatan_eskul` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
